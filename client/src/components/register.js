...
<div className="form-check form-check-inline">
  ...
  <label className="form-check-label" htmlFor="Reg-Female">Female</label>
                        ...
                        <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <div className="form-outline flex-fill mb-0">
                          <Link to = "/payment">Already Registered ?</Link>

                          </div>
                          <button type="Submit" form='user-Details'  value = "Submit" className="btn btn-primary btn-lg" style={{background: "#d62196",borderColor: "#d62196"}}>Register</button>
                        </div>
</form>
